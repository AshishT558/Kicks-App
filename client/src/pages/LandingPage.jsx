                ...
                <div className="h-[120rem]">
                    ...
                    <div className="flex flex-col items-center h-screen">
                        ...
                        <div className="flex flex-col items-center h-screen fade-in">
                            <div className="flex flex-col gap-y-5 text-3xl lg:text-6xl pt-[15rem]">
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-4 place-items-center lg:gap-x-[10rem] pt-10">
                            ...
                            <div className="grid grid-cols-2 align-center gap-x-10 pt-10">
                                <NavLink to="/gallery">
